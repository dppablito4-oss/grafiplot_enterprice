...
export function PublicFooter() {
  return (
    <footer id="contacto" className="bg-slate-900 dark:bg-slate-950 border-t border-white/5 pt-16 pb-8 transition-colors duration-500">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 mb-10">
          ...
          <div className="lg:col-span-5 space-y-6">
            ...
            <p className="text-slate-400 dark:text-slate-400 max-w-md text-lg leading-relaxed font-light tracking-tight">
          ...
          <div className="lg:col-span-3">
            <h4 className="text-white dark:text-white font-black text-xs tracking-[0.3em] uppercase mb-6">Plataforma</h4>
            <ul className="space-y-3">
              <li><Link to="/login" className="text-slate-400 dark:text-slate-400 hover:text-brand-red dark:hover:text-brand-yellow transition-colors text-sm font-bold tracking-tight uppercase">Acceso Clientes</Link></li>
              ...
              <li><Link to="/terminos" className="text-slate-400 dark:text-slate-400 hover:text-brand-red dark:hover:text-brand-yellow transition-colors text-sm font-bold tracking-tight uppercase">Términos y Privacidad (IA)</Link></li>
            </ul>
          </div>

          {/* Contact Data */}
          <div className="lg:col-span-4 space-y-6">
            <h4 className="text-white dark:text-white font-black text-xs tracking-[0.3em] uppercase mb-6">Atención Directa</h4>
            <div className="space-y-4">
              <div className="flex items-start gap-5 group">
                ...
                <p className="text-sm text-slate-400 dark:text-slate-400 font-medium group-hover:text-white dark:group-hover:text-white transition-colors leading-relaxed tracking-tight">
              ...
              <div className="flex items-center gap-5 group">
                ...
                <p className="text-sm text-slate-400 dark:text-slate-400 font-black group-hover:text-white dark:group-hover:text-white transition-colors tracking-widest uppercase">
                  952 628 844
                </p>
              </div>
            </div>
