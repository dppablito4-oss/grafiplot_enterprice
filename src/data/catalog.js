...
// Nota: Toda la lógica de precios y matrices se encuentra centralizada
// en `src/lib/pricing.js` para mantener una única fuente de verdad.
// No duplicar matrices de precios aquí.
